    ...
    plugins: [
        laravel({
            input: [
                ...
                'resources/js/minha_liga_onboarding_clube.jsx',
                ...
                'resources/js/liga_mercado_propostas.jsx',
