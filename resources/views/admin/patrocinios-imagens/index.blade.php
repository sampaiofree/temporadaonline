...
<x-app-layout title="Imagens dos patrocínios">
    <x-slot name="header">
        <div class="flex items-center justify-between gap-4">
            <div>
                <h2 class="text-2xl font-bold text-slate-800">Imagens dos patrocínios</h2>
                <p class="text-sm text-slate-500">Cadastre e organize os arquivos dos patrocinadores.</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="space-y-6">
        ...
        @include('admin.imagens._mass_upload', [
            'title' => 'Upload em massa de patrocínios',
            'description' => 'Selecione um ou vários arquivos e confirme o nome antes de salvar.',
            'formAction' => route('admin.patrocinios-imagens.store'),
            'formId' => 'patrocinios-imagens-mass-upload-form',
            'inputId' => 'patrocinios-imagens-mass-upload-input',
            'previewId' => 'patrocinios-imagens-mass-upload-preview',
            'errorId' => 'patrocinios-imagens-mass-upload-error',
            'fileLabel' => 'Imagens dos patrocínios',
            'inputHint' => 'Os nomes dos arquivos serão convertidos automaticamente em nomes dos patrocínios, mas você pode ajustá-los no preview.',
                            ...
                            <tr class="hover:bg-slate-50 transition-colors">
                                ...
                                <td class="px-4 py-4 align-top">
                                    <div class="flex flex-wrap gap-2">
                                        <a
                                            href="{{ route('admin.patrocinios-imagens.edit', $imagem) }}"
                                        ...
                                        <form action="{{ route('admin.patrocinios-imagens.destroy', $imagem) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button
                                                type="submit"
