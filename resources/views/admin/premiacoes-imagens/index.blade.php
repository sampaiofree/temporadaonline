...
<x-app-layout title="Imagens das premiações">
    <x-slot name="header">
        <div class="flex items-center justify-between gap-4">
            <div>
                <h2 class="text-2xl font-bold text-slate-800">Imagens das premiações</h2>
                <p class="text-sm text-slate-500">Gerencie os ativos visuais das premiações do clube.</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="space-y-6">
        ...
        @include('admin.imagens._mass_upload', [
            'title' => 'Upload em massa de premiações',
            'description' => 'Selecione um ou vários arquivos e confirme o nome antes de salvar.',
            'formAction' => route('admin.premiacoes-imagens.store'),
            'formId' => 'premiacoes-imagens-mass-upload-form',
            'inputId' => 'premiacoes-imagens-mass-upload-input',
            'previewId' => 'premiacoes-imagens-mass-upload-preview',
            'errorId' => 'premiacoes-imagens-mass-upload-error',
            'fileLabel' => 'Imagens das premiações',
            'inputHint' => 'Os nomes dos arquivos serão convertidos automaticamente em nomes das premiações, mas você pode ajustá-los no preview.',
                            ...
                            <tr class="hover:bg-slate-50 transition-colors">
                                ...
                                <td class="px-4 py-4 align-top">
                                    <div class="flex flex-wrap gap-2">
                                        <a
                                            href="{{ route('admin.premiacoes-imagens.edit', $imagem) }}"
                                        ...
                                        <form action="{{ route('admin.premiacoes-imagens.destroy', $imagem) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button
                                                type="submit"
