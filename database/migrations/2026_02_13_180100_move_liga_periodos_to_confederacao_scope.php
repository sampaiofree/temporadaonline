...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $hasLigaId = Schema::hasColumn('liga_periodos', 'liga_id');

        if (! Schema::hasColumn('liga_periodos', 'confederacao_id')) {
            Schema::table('liga_periodos', function (Blueprint $table) use ($hasLigaId): void {
        ...
        $duplicates = DB::table('liga_periodos')
        ...
        if (Schema::hasColumn('liga_periodos', 'liga_id')) {
            try {
                Schema::table('liga_periodos', function (Blueprint $table): void {
                    $table->dropIndex('liga_periodos_liga_id_inicio_fim_index');
                });
            } catch (\Throwable) {
        ...
        Schema::table('liga_periodos', function (Blueprint $table): void {
            ...
            $table->index(['confederacao_id', 'inicio', 'fim'], 'liga_periodos_confederacao_inicio_fim_idx');
        });
    }
    ...
    public function down(): void
    {
        ...
        if (Schema::hasColumn('liga_periodos', 'confederacao_id')) {
            Schema::table('liga_periodos', function (Blueprint $table): void {
                $table->dropIndex('liga_periodos_confederacao_inicio_fim_idx');
